        ...
        <div className="ml-16 pb-4 bg-gray-200" style={{ minHeight: "92.7vh" }}>
            ...
            {invoice?.creator?.includes(user?.result?._id) && (
                <div className="text-center">
                    ...
                    <Modal open={openn} setOpen={setOpenn} invoice={invoice} />
                </div>
            )}
                ...
                <form>
                    ...
                    <div className="flex justify-between px-4">
                        ...
                        <div className="my-4 w-1/2 text-end">
                            ...
                            <h1
                                ...
                                style={{ color: totalAmountReceived >= total ? "green" : "red" }}
                            >
                                {totalAmountReceived >= total ? "Paid" : "Unpaid"}
                            </h1>
                    ...
                    {invoiceData.notes !== undefined ? (
                        <div className="mb-20">
                            ...
                            <p className="text-sm w-full h-24 p-2 border-zinc-600 border-2 rounded-md">
                                {invoiceData.notes}
                            </p>
                        </div>
                    ) : (
