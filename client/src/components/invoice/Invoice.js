  ...
  return (
    <div className='ml-16 pb-4 bg-gray-200' style={{minHeight: "92.7vh"}}>
        ...
        <form onSubmit={handleSubmit}>
                ...
                <div className='my-4 w-1/2'>
                    ...
                    {client && (
                      <div>
                        ...
                        <button className='text-blue-700' onClick={() => setClient(null)}>Change</button>
                      </div>
                    )}
                    <div style={ client ? {display: 'none'} : {display: 'block'}}>
                      ...
                      {clients?.map((option) => (
                          <MenuItem key={option.name} value={option.name} onClick={() => setClient(option)}>
                          {option.name}
                          </MenuItem>
                      ))}
                      </TextField>
                    ...
                    { !client && (
                      <div className=''>
                      <button className="border-gray-400 border rounded-3xl btn-sm text-lg normal-case mt-3 hover:bg-gray-200 h-10 text-gray-600" type='button' onClick={handleClickOpen}><AddCircleIcon sx={{marginRight:"5px", fontSize:"30px"}}/>New Customer</button>
                      </div>
                    )}
            ...
            <div>
              <button type='button' onClick={handleAddField} className='my-2 ml-2'><AddCircleOutlinedIcon style={{color:"#1976D2", fontSize:"40px"}}/></button>
            </div>
            ...
            <div className='flex justify-center'>
                <button className="btn btn-sm text-xl mt-4 normal-case bg-blue-600 text-white
                hover:bg-blue-500 border-none  w-1/3 h-10" type='submit'>
